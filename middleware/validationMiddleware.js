...
const validateRegister = [
  ...
  // Phone: optional for buyer/seller, required for agent. Accepts AU (04XX XXX XXX) or international.
  body('phone')
...
const validateProperty = [
  ...
  body('zipCode')
    .matches(/^\d{4}$|^\d{5}(-\d{4})?$/)
    .withMessage('Please provide a valid postcode (AU: 4 digits, US: 5 or 9 digits)'),
